	...
	%>		
			<tr height="70">	
				...
				<td width="90" align="center">
					<%-- 버튼 입력시 id와 대여일 예약차량 고유번호 보내기 --%>
					<button onclick="location.href='15_carReserveDel.jsp?id=<%= id %>&rday=<%= bean.getRday() %>&reserve_seq=<%= bean.getReserve_seq()%>'">
					삭제</button>
				</td>
			</tr>
	<%
