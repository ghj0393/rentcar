 ...
 <% 
	...
	<table>
		<tr height="70">
			...
			<td align="right" width="200">
				...
				<%
					if(id.equals("GUEST")){
				%>
				<button onclick="location.href='01_carMain.jsp?center=05_memberLogin.jsp'"> 로그인 </button><br><br>
				<button onclick="location.href='01_carMain.jsp?center=25_memberJoin.jsp'"> 회원가입 </button>
				<button onclick="location.href='01_carMain.jsp?center=27_memberDelete.jsp'"> 회원탈퇴 </button>
				<%						
					}else{
				 %>
		...
		<tr height="50">
			...
			<td align="center" width="200" bgcolor="pink">
				<font color="white" size="5"><a href="01_carMain.jsp?center=16_freeBoard.jsp" 
